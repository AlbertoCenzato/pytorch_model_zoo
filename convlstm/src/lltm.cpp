...
std::vector<at::Tensor> lltm_backward(at::Tensor grad_h, at::Tensor grad_cell,  //these are the gradients coming from timestep t+1
                                      at::Tensor new_cell, at::Tensor input_gate,  // all variables that are part of the cell state
                                      at::Tensor output_gate, at::Tensor candidate_cell,
                                      at::Tensor X, at::Tensor gate_weights,
                                      at::Tensor weights) {
  ...
  auto d_gates = at::cat({d_input_gate, d_output_gate, d_candidate_cell}, /*dim=*/1);
